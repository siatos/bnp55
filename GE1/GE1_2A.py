    ...
    while True:
        try:
            ...
            if  1900 < year <= 2024:
                ...
                print("year entry should be in [1900, 2024]")
        except ValueError:
        ...
        if len(in_month) == 0:
            ...
            try:
                ...
                if  1 <= month <= 12:
                    ...
                    print("month entry should be in [1, 12]")
            except ValueError:
...
if __name__ == '__main__':
    ...
    end_date = date(TYEAR, TMONTH, TDAY)
    hours = ((end_date - start_date).days)*24
    if hours > 0:
        print("protein {} is known for {} hrs before end of {}".format(protein, hours, TYEAR))
    else:
        print("protein {} has been known for {} hrs after end of {}".format(protein, abs(hours), TYEAR))
