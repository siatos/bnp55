...
if __name__ == '__main__':
    ...
    L3 = L3 + L[1]
    print("New list - all values of the lists joined: {}".format(L3))
    L3 = L3[2:]
    print("New list of values without the first list is: {}".format(L3))
    ...
    L3.reverse()
    print("new list of values without the first list reversed is: {}".format(L3))
